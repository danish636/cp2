...
#   if os.path.isfile("media/hist data2/" + symbol + ".csv"):
#     data = pd.read_csv("media/hist data2/" + symbol + ".csv",parse_dates=["date"])
#   else:
#     df = pd.read_json("https://financialmodelingprep.com/api/v3/historical-price-full/"+ symbol + "?timeseries=1&apikey=b1360803f80dd08bdd0211c5c004ad03")
